...
public class ClassUtils {
	/**  
     * 通过反射,获得指定类的父类的泛型参数的实际类型. 如获取UserService extends BaseService<String,User,UserMapper>中,BaseService上的泛型参数  
     *  
	...
	/**  
     * 通过反射,获得指定类的父类的泛型参数的实际类型. 如获取UserService extends BaseService<String,User,UserMapper>中,BaseService上的泛型参数String  
     *  
	...
	public static <T> T convert(Object entity,Class<T> clazz){
	...
	public static void setProperty(Object obj,String property,String propertyValue){
		try {
