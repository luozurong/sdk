...
<script type="text/javascript" src="js/model/platformJoin/application.js"></script>
</head>
<body>
<div class="position">
	<div class="center">
...
<div id="scrollContent">
	<s:form id="application" action="application.html" theme="simple">
		<div class="box2" roller="false">
				<table >
					<tr>
						...
						<hori:auth value="LXJSDK:12101:1210102:search">
						<td >
		...
		<div>
			<display:table name="plats" class="tableStyle" id="pla" requestURI="application.html"
				...
				<display:column property="appName" sortable="false" headerClass="sortable"
								title="应用名称"
								style="word-break:break-all;"/>
				<display:column property="appPackage" sortable="false" headerClass="sortable"
								title="app包名"
								style="word-break:break-all;"/>
				<display:column media="html" sortable="false" headerClass="sortable" title="APP类型" style="width:3%">
		    		<c:choose>
		    			<c:when test="${pla.appType=='1'}">
		    					<span>安卓</span>
		    			</c:when>
				...
				<display:column media="html" sortable="false" headerClass="sortable" title="操作" style="width:7%">
					<hori:auth value="LXJSDK:12101:1210102:view">		
					<span class="img_view hand" title="查看" style="margin-left:5px;"
								onclick="view('${pla.id}')"></span></hori:auth>
					<hori:auth value="LXJSDK:12101:1210102:audit">
					<c:if test="${pla.verifyStatus=='0' || pla.verifyStatus ==null}">
						<span class="img_guard hand" title="审核" style="margin-left:5px;"
